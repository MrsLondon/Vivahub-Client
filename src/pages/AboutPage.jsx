...
export const AboutPage = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-[#4A4A4A] dark:text-gray-200 font-body transition-colors duration-300">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#F8F8F8] to-[#F0F7FF] dark:from-gray-800 dark:to-gray-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-heading font-bold text-[#4A4A4A] dark:text-gray-200 mb-6 animate-fade-in">
            About VivaHub
          </h1>
          <p className="text-xl text-[#4A4A4A]/80 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
      ...
      <br></br>
       ...
       <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Ayat */}
            <div className="team-member text-center bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <img
                ...
                alt="Ayat Abu Haj"
                className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-[#F8F8F8] dark:border-gray-700"
              />
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="bg-[#F8F8F8] dark:bg-gray-800 rounded-xl p-8 space-y-6">
            <div>
